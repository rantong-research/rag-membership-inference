...
| 指标 | 成员 | 非成员 |
| --- | ---: | ---: |
| 平均 MIA 得分 | 0.5917 | 0.4733 |
| 回答正确率 | 65.31% | 58.39% |

| 指标 | 结果 |
| --- | ---: |
| 文档级 ROC-AUC（答案信号） | 0.5864 |
| 文档级 ROC-AUC（私有使用率信号） | 0.6312 |
| Mann-Whitney p | 0.120 |
| 目标文档检索率 | 97.96% |

> 对比：DP 机制把 MIA 的 ROC-AUC 从 0.98 压到约 0.59~0.63，显著削弱了成员推断能力，量化了「隐私保护 vs 系统效用」的权衡。
